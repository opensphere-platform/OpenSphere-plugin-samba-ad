...
check('ui: custom element owns PostgreSQL full-width host layout contract',
  /this\.style\.display\s*=\s*['"]block['"]/.test(uiShell) &&
  /this\.style\.width\s*=\s*['"]100%['"]/.test(uiShell) &&
  /this\.style\.minWidth\s*=\s*['"]0['"]/.test(uiShell));
